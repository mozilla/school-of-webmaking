...
'<div class="thumbnail">' +
'  <a href="#" class="make-link">' +
'    <div class="thumbnail-wrapper make-thumbnail"></div>' +
'  </a>' +
'  <div class="caption make-details">' +
'    <h3><a href="#" class="make-details-link"></a></h3>' +

'    <p class="make-meta text-muted">' +
'      <img class="make-user-avatar">' +
'      <span class="make-meta-author">Created by <a href="#" class="make-details-user">@flukeout</a></span>' +
'      <span class="make-meta-timestamp"><span class="make-details-timestamp"></span> ago</span>' +
'      <span class="make-likes">,'+
...
'       <a href="#" class="btn btn-primary make-remix" role="button">' +
'         <span class="fa fa-code-fork"></span> Remix' +
'       </a>' +
'       <a href="#" class="btn btn-danger make-like" role="button">' +
'         <span class="fa fa-heart"></span><span class="sr-only">Like</span>' +
'       </a>'+
'    </p>' +
'  </div>' +
'</div>'+
